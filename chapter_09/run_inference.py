"""第 09 期独立的自然语言 FlashAttention 推理入口。"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="运行 Eager 或手写 FlashAttention")
    ...
    parser.add_argument(
        "--attention-backend", choices=("eager", "flash"), default="flash"
    )
...
def main():
    ...
    print("\n=== Attention backend: %s ===" % args.attention_backend)
